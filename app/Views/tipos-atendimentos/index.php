...
formTipo.addEventListener('submit', async event => {
    ...
    try {
        ...
        AtendeLabApi.showAlert('alerta', id ? 'Tipo atualizado!' : 'Tipo cadastrado!');
        fecharFormulario(); carregarTipos();
    } catch (error) { AtendeLabApi.showAlert('alerta', error.message, 'danger'); }
});
...
async function inativarTipo(id) {
    ...
    try {
        ...
        AtendeLabApi.showAlert('alerta', 'Tipo inativado!');
        carregarTipos();
    } catch (error) { AtendeLabApi.showAlert('alerta', error.message, 'danger'); }
}
