...
const statusModal = () => { return bootstrap.Modal.getOrCreateInstance(document.getElementById('modalStatus')); };
...
async function carregarAtendimentos() {
    try {
        ...
        tbody.innerHTML = atendimentos.map(atendimento => {
            ...
            const tipo = labelRegistro(atendimento, 'tipo', 'tipo_nome', 'nome_tipo');
            const responsavel = labelRegistro(atendimento, 'responsavel_nome', 'responsavel', 'usuario_nome');
